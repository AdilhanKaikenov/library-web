...
<t:page title="edit.book.amount.page">
    ...
    <%--@elvariable id="orderedBookNumber" type="java.lang.Integer"--%>
    <div align="center">
        ...
        <form action="${pageContext.request.contextPath}/do/" method="post">
            ...
            <ftm:message key="book.amount"/>: <input type="number" name="bookAmount" value="${book.totalAmount}" min="${orderedBookNumber}" style="width: 55px;">
            <button type="submit"
                    onclick="return confirm('<ftm:message key="confirm.change.book.amount"/>')"
