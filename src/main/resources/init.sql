...
INSERT INTO PUBLIC.book (title, cover, authors, publish_year, genre, description, total_amount) VALUES
  ...
  ('Physics at every step', 'cover10.jpg', 'Yakov Perelman', 2009, 4, 'One of the best benefits of classical physics. Interesting stories, instructive experiments, interesting facts will teach the inquisitive reader to notice the simplest physical phenomena and understand their nature.', 10);
